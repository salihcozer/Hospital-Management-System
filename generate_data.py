...
# Türkçe veriler üretmesi için 'tr_TR' kullanıyoruz
fake = Faker('tr_TR')

# Üretilecek veri miktarları (Şov yapmak istersen bunları 10.000 yapabilirsin!)
NUM_PATIENTS = 500
NUM_DOCTORS = 30
NUM_APPOINTMENTS = 1500
NUM_MEDICATIONS = 20

# Dosyayı yazmaya başlıyoruz
with open('hastane_verileri.sql', 'w', encoding='utf-8') as f:
    f.write("-- PYTHON FAKER İLE ÜRETİLMİŞ HASTANE VERİ SETİ\n")
    f.write("PRAGMA foreign_keys = ON;\n\n")

    # 1. POLİKLİNİKLER (Gerçekçi olması için sabit liste)
    ...
    for i in range(1, NUM_PATIENTS + 1):
        ...
        # Sözlüğü SQL için JSON stringine çeviriyoruz
    ...
    for i in range(1, NUM_APPOINTMENTS + 1):
        ...
        # Eğer randevu tamamlandıysa, bir Tıbbi Kayıt (Muayene sonucu) oluşturalım
        if status == 'Tamamlandı':
            ...
            completed_records.append(len(completed_records) + 1) # Kayıt ID'sini tut
    ...
    # 7. REÇETELER
    f.write("\n-- 7. REÇETELER\n")
    # Tamamlanan muayenelerin yaklaşık yarısına reçete yazalım
...
print("Tebrikler! hastane_verileri.sql dosyası başarıyla oluşturuldu. VS Code üzerinden SQLite'a aktarabilirsin.")